...
var args31721 = [];
var len__28942__auto___31725 = arguments.length;
var i__28943__auto___31726 = (0);
while(true){
if((i__28943__auto___31726 < len__28942__auto___31725)){
args31721.push((arguments[i__28943__auto___31726]));

var G__31727 = (i__28943__auto___31726 + (1));
i__28943__auto___31726 = G__31727;
continue;
} else {
}
break;
...
var G__31724 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__31724,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__31724;
}
});
...
var or__27867__auto__ = cljs.test._STAR_current_env_STAR_;
...
var len__28942__auto___31732 = arguments.length;
var i__28943__auto___31733 = (0);
while(true){
if((i__28943__auto___31733 < len__28942__auto___31732)){
args__28949__auto__.push((arguments[i__28943__auto___31733]));

var G__31734 = (i__28943__auto___31733 + (1));
i__28943__auto___31733 = G__31734;
continue;
} else {
}
break;
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__28950__auto__);
});
...
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq31729){
var G__31730 = cljs.core.first.call(null,seq31729);
var seq31729__$1 = cljs.core.next.call(null,seq31729);
var G__31731 = cljs.core.first.call(null,seq31729__$1);
var seq31729__$2 = cljs.core.next.call(null,seq31729__$1);
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__31730,G__31731,seq31729__$2);
});
...
var map__31738 = m;
var map__31738__$1 = ((((!((map__31738 == null)))?((((map__31738.cljs$lang$protocol_mask$partition0$ & (64))) || (map__31738.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__31738):map__31738);
...
return [cljs.core.str(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__31738,map__31738__$1,file,line,column){
return (function (p1__31735_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__31735_SHARP_));
});})(map__31738,map__31738__$1,file,line,column))
 ...
 */
cljs.test.report = (function (){var method_table__28792__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);
...
return (new cljs.core.MultiFn(cljs.core.symbol.call(null,"cljs.test","report"),((function (method_table__28792__auto__,prefer_table__28793__auto__,method_cache__28794__auto__,cached_hierarchy__28795__auto__,hierarchy__28796__auto__){
return (function (m){
...
var formatter_fn = (function (){var or__27867__auto__ = new cljs.core.Keyword(null,"formatter","formatter",-483008823).cljs$core$IFn$_invoke$arity$1(cljs.test.get_current_env.call(null));
if(cljs.core.truth_(or__27867__auto__)){
return or__27867__auto__;
} else {
...
var temp__4657__auto___31740 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___31740)){
var message_31741 = temp__4657__auto___31740;
cljs.core.println.call(null,message_31741);
} else {
}
...
var temp__4657__auto___31742 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___31742)){
var message_31743 = temp__4657__auto___31742;
cljs.core.println.call(null,message_31743);
} else {
}
...
var temp__4655__auto__ = (function (){var and__27855__auto__ = typeof exception.stack === 'string';
if(and__27855__auto__){
var G__31753 = exception.stack;
var G__31753__$1 = (((G__31753 == null))?null:clojure.string.split_lines.call(null,G__31753));
var G__31753__$2 = (((G__31753__$1 == null))?null:cljs.core.get.call(null,G__31753__$1,depth));
if((G__31753__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__31753__$2);
}
} else {
...
var vec__31754 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__31754,(0),null);
var column = cljs.core.nth.call(null,vec__31754,(1),null);
var vec__31757 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__31757,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__31757,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__31757,(2),null);
...
var m__$1 = (function (){var G__31761 = (((new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m) instanceof cljs.core.Keyword))?new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m).fqn:null);
switch (G__31761) {
case "fail":
...
var G__31767 = (function (){var G__31766 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__31766);
} else {
return G__31766;
}
})();
...
return cljs.core.vary_meta.call(null,G__31769,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
}catch (e31772){var e = e31772;
var G__31773 = (((e instanceof cljs.core.Keyword))?e.fqn:null);
switch (G__31773) {
...
var vec__31778 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__31778,(0),null);
var types = vec__31778;
...
return cljs.core.map.call(null,(function (p__31790){
var vec__31791 = p__31790;
var ns = cljs.core.nth.call(null,vec__31791,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__31791,(1),null);
return ((function (vec__31791,ns,vars__$1){
return (function (){
...
var G__31794 = (((cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures) instanceof cljs.core.Keyword))?cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures).fqn:null);
switch (G__31794) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__31794,env,once_fixtures,each_fixtures,vec__31791,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__31794,env,once_fixtures,each_fixtures,vec__31791,ns,vars__$1){
return (function (){
var seq__31795 = cljs.core.seq.call(null,vars__$1);
var chunk__31796 = null;
var count__31797 = (0);
var i__31798 = (0);
while(true){
if((i__31798 < count__31797)){
var v = cljs.core._nth.call(null,chunk__31796,i__31798);
var temp__4657__auto___31800 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___31800)){
var t_31801 = temp__4657__auto___31800;
each_fixture_fn.call(null,((function (seq__31795,chunk__31796,count__31797,i__31798,t_31801,temp__4657__auto___31800,v,each_fixture_fn,G__31794,env,once_fixtures,each_fixtures,vec__31791,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_31801)));
});})(seq__31795,chunk__31796,count__31797,i__31798,t_31801,temp__4657__auto___31800,v,each_fixture_fn,G__31794,env,once_fixtures,each_fixtures,vec__31791,ns,vars__$1))
);
} else {
}
...
var c__28678__auto__ = cljs.core.chunk_first.call(null,seq__31795__$1);
var G__31806 = cljs.core.chunk_rest.call(null,seq__31795__$1);
var G__31807 = c__28678__auto__;
var G__31808 = cljs.core.count.call(null,c__28678__auto__);
var G__31809 = (0);
seq__31795 = G__31806;
...
var v = cljs.core.first.call(null,seq__31795__$1);
var temp__4657__auto___31810__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___31810__$1)){
var t_31811 = temp__4657__auto___31810__$1;
each_fixture_fn.call(null,((function (seq__31795,chunk__31796,count__31797,i__31798,t_31811,temp__4657__auto___31810__$1,v,seq__31795__$1,temp__4657__auto__,each_fixture_fn,G__31794,env,once_fixtures,each_fixtures,vec__31791,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_31811)));
});})(seq__31795,chunk__31796,count__31797,i__31798,t_31811,temp__4657__auto___31810__$1,v,seq__31795__$1,temp__4657__auto__,each_fixture_fn,G__31794,env,once_fixtures,each_fixtures,vec__31791,ns,vars__$1))
);
} else {
}

var G__31812 = cljs.core.next.call(null,seq__31795__$1);
var G__31813 = null;
var G__31814 = (0);
var G__31815 = (0);
seq__31795 = G__31812;
chunk__31796 = G__31813;
count__31797 = G__31814;
i__31798 = G__31815;
continue;
}
} else {
...
});})(each_fixture_fn,G__31794,env,once_fixtures,each_fixtures,vec__31791,ns,vars__$1))
);
});})(each_fixture_fn,G__31794,env,once_fixtures,each_fixtures,vec__31791,ns,vars__$1))
], null);
