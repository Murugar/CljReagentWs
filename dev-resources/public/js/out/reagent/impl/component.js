...
if((i < len)){
var k = (ks[i]);
var G__38673 = cljs.core.assoc.call(null,m,cljs.core.keyword.call(null,k),(o[k]));
var G__38674 = (i + (1));
m = G__38673;
i = G__38674;
continue;
...
return (cljs.core.fn_QMARK_.call(null,c)) && (cljs.core.some_QMARK_.call(null,(function (){var G__38678 = c;
var G__38678__$1 = (((G__38678 == null))?null:G__38678.prototype);
if((G__38678__$1 == null)){
return null;
} else {
return (G__38678__$1["reagentRender"]);
}
})()));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return (cljs.core.fn_QMARK_.call(null,c)) && (cljs.core.some_QMARK_.call(null,(function (){var G__38682 = c;
var G__38682__$1 = (((G__38682 == null))?null:G__38682.prototype);
if((G__38682__$1 == null)){
return null;
} else {
return (G__38682__$1["render"]);
}
})()));
});
...
while (G__38687__i < G__38687__a.length) {G__38687__a[G__38687__i] = arguments[G__38687__i + 0]; ++G__38687__i;}
  args = new cljs.core.IndexedSeq(G__38687__a,0);
} 
...
var _STAR_current_component_STAR_38691 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_38691;
}});
...
var G__38695 = (((key instanceof cljs.core.Keyword))?key.fqn:null);
switch (G__38695) {
...
var or__27867__auto__ = reagent.impl.util._STAR_always_update_STAR_;
...
var c = this;
var G__38697_38699 = (c["cljsRatom"]);
if((G__38697_38699 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__38697_38699);
}
...
if(cljs.core.truth_((function (){var and__27855__auto__ = wrap;
...
if(((1) === cljs.core.count.call(null,renders_38702))){
} else {
...
if(cljs.core.ifn_QMARK_.call(null,render_fun_38703)){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str([cljs.core.str("Render must be a function, not "),cljs.core.str(cljs.core.pr_str.call(null,render_fun_38703))].join('')),cljs.core.str("\n"),cljs.core.str("(ifn? render-fun)")].join('')));
}


var render_fun = (function (){var or__27867__auto__ = new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383).cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__27867__auto__)){
return or__27867__auto__;
} else {
...
var render_fun__$1 = (function (){var or__27867__auto__ = render_fun;
if(cljs.core.truth_(or__27867__auto__)){
return or__27867__auto__;
} else {
...
var name = [cljs.core.str((function (){var or__27867__auto__ = new cljs.core.Keyword(null,"displayName","displayName",-809144601).cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__27867__auto__)){
return or__27867__auto__;
} else {
...
var name__$1 = (function (){var G__38701 = name;
switch (G__38701) {
case "":
...
var G__38706 = o;
(G__38706[cljs.core.name.call(null,k)] = v);
...
var elem = (function (){var G__38712 = (function (){var or__27867__auto__ = (function (){var G__38714 = c;
if((G__38714 == null)){
return null;
} else {
return (G__38714["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__27867__auto__)){
return or__27867__auto__;
...
return (G__38712["_currentElement"]);
}
})();
var name = (function (){var G__38715 = elem;
var G__38715__$1 = (((G__38715 == null))?null:(G__38715["type"]));
if((G__38715__$1 == null)){
return null;
} else {
return (G__38715__$1["displayName"]);
}
})();
var path = (function (){var G__38716 = elem;
var G__38716__$1 = (((G__38716 == null))?null:(G__38716["_owner"]));
var G__38716__$2 = (((G__38716__$1 == null))?null:reagent$impl$component$component_path.call(null,G__38716__$1));
if((G__38716__$2 == null)){
return null;
} else {
return [cljs.core.str(G__38716__$2),cljs.core.str(" > ")].join('');
}
})();
...
var n = (function (){var or__27867__auto__ = reagent.impl.component.component_path.call(null,c);
if(cljs.core.truth_(or__27867__auto__)){
return or__27867__auto__;
} else {
var G__38718 = c;
var G__38718__$1 = (((G__38718 == null))?null:G__38718.constructor);
if((G__38718__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name.call(null,G__38718__$1);
}
}
})();
