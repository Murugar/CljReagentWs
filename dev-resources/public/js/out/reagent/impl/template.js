...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__28473__auto__,writer__28474__auto__,opt__28475__auto__){
return cljs.core._write.call(null,writer__28474__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__38740 = o;
(G__38740[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__38741__delegate = function (args){
...
while (G__38742__i < G__38742__a.length) {G__38742__a[G__38742__i] = arguments[G__38742__i + 0]; ++G__38742__i;}
  args = new cljs.core.IndexedSeq(G__38742__a,0);
} 
return G__38741__delegate.call(this,args);};
G__38741.cljs$lang$maxFixedArity = 0;
G__38741.cljs$lang$applyTo = (function (arglist__38743){
var args = cljs.core.seq(arglist__38743);
return G__38741__delegate(args);
});
...
if(cljs.core.truth_((function (){var and__27855__auto__ = cljs.core.some_QMARK_.call(null,reagent.impl.template.find_dom_node);
if(and__27855__auto__){
var and__27855__auto____$1 = cljs.core.some_QMARK_.call(null,jsprops);
if(and__27855__auto____$1){
var and__27855__auto____$2 = (jsprops["hasOwnProperty"])("onChange");
...
var G__38748 = jsprops;
(G__38748["defaultValue"] = value);

(G__38748["onChange"] = ((function (G__38748,v,value,on_change){
return (function (p1__38746_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__38746_SHARP_);
});})(G__38748,v,value,on_change))
);
...
var vec__38755 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__38755,(0),null);
var id = cljs.core.nth.call(null,vec__38755,(1),null);
var class$ = cljs.core.nth.call(null,vec__38755,(2),null);
...
var jsprops = {"argv": v};
var temp__4661__auto___38760 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___38760 == null)){
} else {
var key_38761 = temp__4661__auto___38760;
(jsprops["key"] = key_38761);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__38763 = (new reagent.impl.template.NativeWrapper());
(G__38763["name"] = c);
...
var len__28942__auto___38769 = arguments.length;
var i__28943__auto___38770 = (0);
while(true){
if((i__28943__auto___38770 < len__28942__auto___38769)){
args__28949__auto__.push((arguments[i__28943__auto___38770]));

var G__38771 = (i__28943__auto___38770 + (1));
i__28943__auto___38770 = G__38771;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__28950__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq38767){
var G__38768 = cljs.core.first.call(null,seq38767);
var seq38767__$1 = cljs.core.next.call(null,seq38767);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__38768,seq38767__$1);
});
...
break;
default:
var G__38775 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__38775;
continue;
...
var n__28782__auto___38778 = a.length;
var i_38779 = (0);
while(true){
if((i_38779 < n__28782__auto___38778)){
(a[i_38779] = reagent.impl.template.as_element.call(null,(a[i_38779])));
...
var a = cljs.core.into_array.call(null,s);
var n__28782__auto___38781 = a.length;
var i_38782 = (0);
while(true){
if((i_38782 < n__28782__auto___38781)){
var val_38783 = (a[i_38782]);
if((cljs.core.vector_QMARK_.call(null,val_38783)) && ((reagent.impl.template.key_from_vec.call(null,val_38783) == null))){
(o["no-key"] = true);
} else {
}

(a[i_38782] = reagent.impl.template.as_element.call(null,val_38783));

var G__38784 = (i_38782 + (1));
i_38782 = G__38784;
continue;
} else {
}
...
var ctx = {};
var vec__38788 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__38788,(0),null);
var derefed = cljs.core.nth.call(null,vec__38788,(1),null);
...
var G__38792 = (cljs.core.count.call(null,argv) - first_child);
switch (G__38792) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__38792){
